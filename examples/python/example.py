...
Demonstrates:
  ...
  3. Learning from experience (observation → implicit rule → goal-driven execution)
  4. How DriftNARS calls YOUR code when it decides to act
...
def handle_execution(op_name, args):
    ...
    if op_name == "^press":
        ...
        print(f"  >>> {op_name} executed (args: {args})")
...
with DriftNARS() as nar:
    ...
    # ------------------------------------------------------------------
    print("=" * 60)
    print("EXAMPLE 3: Learning from experience")
    print("=" * 60)
    print()
